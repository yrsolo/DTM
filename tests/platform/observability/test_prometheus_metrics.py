...
from src.platform.observability.composite_metrics import CompositeMetricsClient
from src.platform.observability.metrics import MetricEntry, NoopMetricsClient
from src.platform.observability.prometheus_metrics import YandexManagedPrometheusRemoteWriteClient
...
class PrometheusMetricsClientTestCase(unittest.TestCase):
    ...
    def test_prometheus_client_writes_remote_write_payload(self) -> None:
        ...
        with patch("src.platform.observability.prometheus_metrics.write_prometheus_remote_write", side_effect=_fake_write):
    ...
    def test_prometheus_client_swallow_write_failure(self) -> None:
        logger = _RecordingLogger()
        with patch(
            "src.platform.observability.prometheus_metrics.write_prometheus_remote_write",
    ...
    def test_composite_metrics_client_flush_entries_fans_out(self) -> None:
        class _BatchRecordingMetrics(NoopMetricsClient):
            ...
            def flush_entries(self, entries):
                ...
                from src.platform.observability.metrics import BackendFlushResult
