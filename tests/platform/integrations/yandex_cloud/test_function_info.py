...
class YcFunctionInfoTestCase(unittest.TestCase):
    @patch("src.platform.integrations.yandex_cloud.function_info.get_iam_token", return_value="iam-token")
    @patch("src.platform.integrations.yandex_cloud.function_info.requests.get")
