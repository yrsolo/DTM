...
from src.platform.integrations.grafana.api import upsert_prometheus_datasource


class GrafanaApiTestCase(unittest.TestCase):
    @patch("src.platform.integrations.grafana.api.requests.post")
    @patch("src.platform.integrations.grafana.api.requests.get")
    ...
    @patch("src.platform.integrations.grafana.api.requests.put")
    @patch("src.platform.integrations.grafana.api.requests.get")
