...
from src.platform.integrations.grafana.api import grafana_dashboard_url, grafana_embed_url
...
class GrafanaSpecsTestCase(unittest.TestCase):
    ...
    def test_build_test_grafana_dashboard_contains_snapshot_and_render_panels(self) -> None:
        ...
        self.assertIn("Direct API Outer Breakdown", titles)
        self.assertIn("Direct API Outer vs Inner", titles)
        ...
        outer_panel = next(panel for panel in dashboard["panels"] if panel["title"] == "Direct API Outer Breakdown")
