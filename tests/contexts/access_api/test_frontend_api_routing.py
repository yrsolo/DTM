...
FIXTURE_PATH = Path(__file__).resolve().parents[2] / "fixtures" / "http_event_yc_api_gw.json"
...
class FrontendApiRoutingTestCase(unittest.TestCase):
    def setUp(self) -> None:
        self._orig_get_snapshot_query_api = access_frontend_v2_module.get_snapshot_query_api
        self._orig_access_get_snapshot_query_api = access_frontend_v2_module.get_snapshot_query_api
        self._orig_info_get_snapshot_query_api = access_info_handler_module.get_snapshot_query_api
        self._orig_access_info_get_snapshot_query_api = access_info_handler_module.get_snapshot_query_api
        self._orig_people_get_snapshot_query_api = access_people_snapshot_handler_module.get_snapshot_query_api
        self._orig_access_people_get_snapshot_query_api = access_people_snapshot_handler_module.get_snapshot_query_api
        ...
        access_frontend_v2_module.get_snapshot_query_api = lambda _ctx: self._engine  # type: ignore[assignment]
        access_info_handler_module.get_snapshot_query_api = lambda _ctx: _FakeInfoSnapshotEngine()  # type: ignore[assignment]
        access_people_snapshot_handler_module.get_snapshot_query_api = lambda _ctx: self._engine  # type: ignore[assignment]
    ...
    def tearDown(self) -> None:
        access_frontend_v2_module.get_snapshot_query_api = self._orig_access_get_snapshot_query_api  # type: ignore[assignment]
        access_info_handler_module.get_snapshot_query_api = self._orig_access_info_get_snapshot_query_api  # type: ignore[assignment]
        access_people_snapshot_handler_module.get_snapshot_query_api = self._orig_access_people_get_snapshot_query_api  # type: ignore[assignment]
    ...
    def test_v2_returns_503_when_snapshot_source_unavailable(self) -> None:
        access_frontend_v2_module.get_snapshot_query_api = lambda _ctx: (_ for _ in ()).throw(RuntimeError("s3 down"))  # type: ignore[assignment]
        event = _fixture_event()
        event["pathParams"]["proxy"] = "api/v2/frontend"
        event["params"]["proxy"] = "api/v2/frontend"
        event["url"] = "https://dtm.solofarm.ru/test/ops/api/v2/frontend?statuses=work"
