...
class _OperationalRepoStub:
    ...
    def list_milestones(self, *, task_ids=None):  # noqa: ANN001, ARG002
        return [
            {"task_id": "42", "idx": 1, "type": "storyboard", "planned_date": "2026-03-04", "status": "planned"},
            {"task_id": "42", "idx": 2, "type": "animatic", "planned_date": "2026-03-11", "status": "planned"},
        ]
