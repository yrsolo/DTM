...
|---|---|---|---:|---|---|
| 1 | `DTM-103` | `core.reminder` | 39 | `done` | `agile/tasks/DTM-103_stage12-module-core-reminder.md` |
| 2 | `DTM-104` | `core.manager` | 34 | `done` | `agile/tasks/DTM-104_stage12-module-core-manager.md` |
| 3 | `DTM-105` | `core.repository` | 33 | `done` | `agile/tasks/DTM-105_stage12-module-core-repository.md` |
| 4 | `DTM-106` | `agent.render_adapter_smoke` | 26 | `done` | `agile/tasks/DTM-106_stage12-module-agent-render_adapter_smoke.md` |
| 5 | `DTM-107` | `utils.func` | 22 | `done` | `agile/tasks/DTM-107_stage12-module-utils-func.md` |
| 6 | `DTM-108` | `agent.reminder_retry_backoff_smoke` | 18 | `done` | `agile/tasks/DTM-108_stage12-module-agent-reminder_retry_backoff_smoke.md` |
| 7 | `DTM-109` | `utils.service` | 17 | `done` | `agile/tasks/DTM-109_stage12-module-utils-service.md` |
| 8 | `DTM-110` | `core.people` | 16 | `done` | `agile/tasks/DTM-110_stage12-module-core-people.md` |
| 9 | `DTM-111` | `core.adapters` | 15 | `done` | `agile/tasks/DTM-111_stage12-module-core-adapters.md` |
| 10 | `DTM-112` | `agent.reminder_delivery_counters_smoke` | 10 | `done` | `agile/tasks/DTM-112_stage12-module-agent-reminder_delivery_counters_smoke.md` |
| 11 | `DTM-113` | `agent.reminder_idempotency_smoke` | 10 | `done` | `agile/tasks/DTM-113_stage12-module-agent-reminder_idempotency_smoke.md` |
| 12 | `DTM-114` | `core.contracts` | 10 | `done` | `agile/tasks/DTM-114_stage12-module-core-contracts.md` |
| 13 | `DTM-115` | `agent.reminder_alert_evaluator` | 9 | `done` | `agile/tasks/DTM-115_stage12-module-agent-reminder_alert_evaluator.md` |
| 14 | `DTM-116` | `core.planner` | 9 | `done` | `agile/tasks/DTM-116_stage12-module-core-planner.md` |
| 15 | `DTM-117` | `agent.reminder_parallel_enhancer_smoke` | 8 | `done` | `agile/tasks/DTM-117_stage12-module-agent-reminder_parallel_enhancer_smoke.md` |
