...
- Plan and dynamic estimate:
  - `doc/stages/14_stage7_execution_plan.md`
- Consumer/storage policy:
  - `doc/stages/15_stage7_read_model_consumer_policy.md`
- UI Spike-1 scope and acceptance:
  - `doc/stages/16_stage7_ui_spike_scope_and_acceptance.md`
- Shadow-run readiness gate:
  - `doc/stages/17_stage7_shadow_run_readiness_checklist.md`
- Artifact tooling:
...
4. Execute shadow-run using checklist from `doc/stages/17_stage7_shadow_run_readiness_checklist.md`.
