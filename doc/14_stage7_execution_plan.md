...
2. TSK-067: read-model API change policy and compatibility rules for consumers.
3. TSK-068: exported schema snapshot artifact for frontend integration checks.
4. TSK-069: frontend-friendly static fixture bundle from baseline captures.
...
- Artifacts needed for Stage 8 prototype work are reproducible from local baseline flow.
