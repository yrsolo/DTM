...
async def main():
    ...
    artifact = body.get("meta", {}).get("artifact")
    print("meta.artifact type:", type(artifact).__name__)
    if isinstance(artifact, dict):
        print("meta.artifact keys:", sorted(artifact.keys()))
    else:
        print("meta.artifact value:", artifact)

    access = body.get("meta", {}).get("access", {})
    print("meta.access:", access)
...
if __name__ == "__main__":
    time_call("all", asyncio.run, main())
