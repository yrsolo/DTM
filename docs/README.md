# Ð”Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð°Ñ†Ð¸Ñ DTM

Ð’ `docs/` Ð»ÐµÐ¶Ð¸Ñ‚ ÑÐ¸ÑÑ‚ÐµÐ¼Ð½Ð°Ñ Ð¸ Ð¿Ñ€Ð¾Ð´ÑƒÐºÑ‚Ð¾Ð²Ð°Ñ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð°Ñ†Ð¸Ñ Ð¿Ñ€Ð¾ÐµÐºÑ‚Ð°. Ð­Ñ‚Ð¾ Ð½Ðµ execution-tracking: Ñ€Ð°Ð±Ð¾Ñ‡Ð¸Ðµ Ð¿Ð»Ð°Ð½Ñ‹, ÐºÐ°Ð¼Ð¿Ð°Ð½Ð¸Ð¸ Ð¸ Ñ‚ÐµÐºÑƒÑ‰ÐµÐµ ÑÐ¾ÑÑ‚Ð¾ÑÐ½Ð¸Ðµ Ð¶Ð¸Ð²ÑƒÑ‚ Ð² `work/`.
...
## ÐšÐ¾Ð³Ð´Ð° Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÑŒ ÑÑ‚Ð¾Ñ‚ Ñ€Ð°Ð·Ð´ÐµÐ»

Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐ¹ `docs/`, ÐºÐ¾Ð³Ð´Ð° Ð½ÑƒÐ¶Ð½Ð¾:
...
- [archive/README.md](archive/README.md) â€” Ð¸ÑÑ‚Ð¾Ñ€Ð¸Ñ‡ÐµÑÐºÐ¸Ðµ Ð¸ superseded Ð¼Ð°Ñ‚ÐµÑ€Ð¸Ð°Ð»Ñ‹

## Process boundary

ÐŸÑ€Ð¾Ñ†ÐµÑÑÑ‹, ÐºÐ°Ð¼Ð¿Ð°Ð½Ð¸Ð¸, backlog Ð¸ Ñ‚ÐµÐºÑƒÑ‰ÐµÐµ execution state Ð½Ð°Ñ…Ð¾Ð´ÑÑ‚ÑÑ Ð² [../work/README.md](../work/README.md).
