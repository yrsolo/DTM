...
|---|---|---|---|---|---|
| `README.md`, `docs/README.md`, `docs/campaigns/README.md`, `agile/sprint_current.md`, `agile/backlog.md` | 2026-03-03 | TeamLead agent | direct file read + `rg` scan on active tree + `git log -n 12` drift check | high | active control plane converged to CAM-P-T |
...
- [x] `CAM-DOC-REFORM-P02-T002` `agile/` reduced to active files; legacy moved to archive.
...
- `git mv agile/strategy.md agile/archive/legacy_2026-03-03/strategy.md`
- `git mv agile/retro.md agile/archive/legacy_2026-03-03/retro.md`
- `git mv agile/context_registry.md agile/archive/legacy_2026-03-03/context_registry.md`
- `git mv agile/tasks agile/archive/legacy_2026-03-03/tasks`
