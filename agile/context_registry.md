...
| agile/sprint_current.md | 2026-02-27 | TeamLead | verified board sections and WIP=1 discipline; synchronized DTM-17 lifecycle (`V rabote` -> `Gotovo`) | high | local sprint board is current for this sprint cycle |
