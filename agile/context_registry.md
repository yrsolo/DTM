...
| Jira control plane | 2026-02-27 | TeamLead | shell check: `JIRA_BASE_URL/JIRA_EMAIL/JIRA_API_TOKEN/JIRA_PROJECT_KEY` are missing; owner notified via `python agent/notify_owner.py --title "🚨 Jira недоступна" ...` | low | execution blocked until Jira restored or explicit waiver `LOCAL_ONLY_MODE until <date>` |
