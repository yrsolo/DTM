...
## Work log
- 2026-02-27: Jira `DTM-44` created, moved to `В работе`, start evidence comment added.
- 2026-02-27: Updated `doc/02_baseline_validation_and_artifacts.md` with evaluator-wired baseline command and `alert_evaluation.json` artifact expectations.
...
## Links
- Jira: DTM-44
- Docs: doc/02_baseline_validation_and_artifacts.md, doc/05_risk_register.md
