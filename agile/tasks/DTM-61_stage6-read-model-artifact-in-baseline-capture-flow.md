...
## Work log
- 2026-02-27: Jira `DTM-61` created and moved to `В работе`; start evidence comment posted.
- 2026-02-27: Extended `agent/capture_baseline.py` to pass `--read-model-file` and `--read-model-build-id` into `local_run.py`.
- 2026-02-27: Updated baseline docs/checklist for `read_model.json` artifact (`README.md`, `doc/02_baseline_validation_and_artifacts.md`).
...
## Links
- Jira: DTM-61
- Sources: agent/capture_baseline.py, local_run.py, doc/02_baseline_validation_and_artifacts.md
