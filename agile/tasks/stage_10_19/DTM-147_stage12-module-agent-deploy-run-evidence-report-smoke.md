# DTM-147: Stage 12 deep cleanup for module `agent.deploy_run_evidence_report_smoke`

## Context
- Stage 12 switched to deep per-module execution model.
- Module baseline from audit matrix: `agent.deploy_run_evidence_report_smoke` (`1` item).
...
## Work log
- 2026-02-28: Task generated from Stage 12 module queue and linked to module `agent.deploy_run_evidence_report_smoke`.
- 2026-02-28: Added explicit constants and `_run_checked` helper with resilient decoding, plus concise main docstring.
- 2026-02-28: Checks: `python -m compileall agent`, `.venv\Scripts\python.exe agent\deploy_run_evidence_report_smoke.py`.
