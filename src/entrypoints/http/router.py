...
from src.contexts.access_api.public import (
    get_primary_browser_read_model,
)
...
class HttpRouter:
    ...
    def __init__(self, ctx: AppContext) -> None:
        ...
        self._primary_browser_read_model = get_primary_browser_read_model(ctx)
    ...
    async def dispatch(self, req: HttpRequest) -> HttpResponse | None:
        ...
        handlers = [
            ...
            ("browser_read_model", self._primary_browser_read_model.handle),
        ]
