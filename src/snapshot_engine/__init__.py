...
if TYPE_CHECKING:
    from src.snapshot_engine.engine import SnapshotEngine, SnapshotFrontendQuery


def build_snapshot_engine(*args, **kwargs):
    from src.snapshot_engine.engine import build_snapshot_engine as _build_snapshot_engine
...
def __getattr__(name: str):
    if name in {"SnapshotEngine", "SnapshotFrontendQuery", "build_snapshot_engine"}:
        from src.snapshot_engine import engine as _engine
