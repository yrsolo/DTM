...
- `P15` archival cleanup has started with the former top-level legacy planner/runtime entry and facade modules moved under `src/archive/legacy_runtime/*`; old `src/legacy/*` import paths now act as compatibility wrappers and legacy-suite tests remain green
