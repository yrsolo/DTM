...
## Recent Done
- CAM-2026-06-16-SHOWCASE-VIDEO-POSTER-V1 completed after replacing the promo player poster with an optimized WebP placeholder and pre-play overlay, then verifying Pages deployment.
- CAM-2026-06-16-SHOWCASE-HERO-VIDEO-COPY-POLISH-V1 completed after polishing the public showcase hero, video source, screenshot caption, notification copy, and verifying Pages deployment.
