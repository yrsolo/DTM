...
- CAM-2026-03-14-PEOPLE-SNAPSHOT-AND-SECRET-API-V1 P02: renamed primary people-registry mail fields to explicit `yandex_email` / `yandexEmail` so account-identity semantics are obvious in storage and API
