...
- Policy reference: `archive/docs/doc_legacy/stages/15_stage7_read_model_consumer_policy.md`.
...
- If level is `WARN` or `CRITICAL`, apply escalation policy from `archive/work/roadmap_legacy/plan_legacy/risk_register.md`.
