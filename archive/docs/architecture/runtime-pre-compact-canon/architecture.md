...
- `src/contexts/snapshot/module.py` and `src/contexts/snapshot/application/*` own the exported snapshot APIs
- `src/contexts/snapshot/internal/engine/*` stays as internal build/query/storage implementation detail
