...
## Move Evidence
- `git mv doc archive/docs/doc_legacy`
- `git mv docs/evidence_db_migration_v2.md docs/evidence/db_migration_v2.md`
- `git mv docs/migration_plan.md archive/docs/migration_legacy/migration_plan.md`
- `git mv docs/migration/plan.md archive/docs/migration_legacy/plan.md`
- `git mv docs/migration/tasks.md archive/docs/migration_legacy/tasks.md`
- `git mv agile/strategy.md archive/work/agile_legacy/legacy_2026-03-03/strategy.md`
- `git mv agile/retro.md archive/work/agile_legacy/legacy_2026-03-03/retro.md`
- `git mv agile/context_registry.md archive/work/agile_legacy/legacy_2026-03-03/context_registry.md`
- `git mv agile/tasks archive/work/agile_legacy/legacy_2026-03-03/task_cards_legacy`
