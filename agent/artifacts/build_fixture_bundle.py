...
from src.platform.artifacts.fixture_bundle import build_fixture_bundle
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--baseline-root",
        type=Path,
        default=Path("work") / "artifacts" / "baseline",
        help="Baseline root used when --baseline-dir is not provided (default: work/artifacts/baseline).",
    )
    parser.add_argument(
        "--output-file",
        type=Path,
